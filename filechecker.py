    ...
    class FileChecker:
        def check_dir(self, folder, mkdir):
            ...
            if not os.path.exists(dir):
                ...
                return ("True", f"Directory \"{dir}\" created")
            return ("True", f"Directory \"{dir}\" exists")
        def check_file(self, file, mkfile):
            ...
            if not os.path.exists(dir):
                if mkfile:
                    ...
                    return (False, f"File \"{dir}\" does not exist") 
                return ("True", f"File \"{dir}\" created")
            return ("True", f"File \"{dir}\" exists")
